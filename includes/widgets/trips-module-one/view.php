...
$showPrice_hero    = wte_array_get( $settings, 'showPrice_hero', true );
$showPrice_norm    = wte_array_get( $settings, 'showPrice', true );
...
$price_label_hero  = wte_array_get( $settings, 'priceLabel_hero', __('from', 'wptravelengine-elementor-widgets') );
$price_label_norm  = wte_array_get( $settings, 'priceLabel', __('from', 'wptravelengine-elementor-widgets') );
...
$final_meta_data = (1 === $index || 2 === $index) ? $show_hero_meta : $show_meta_data;
$duration_type   = (1 === $index || 2 === $index) ? $settings['durationType_hero'] : $settings['durationType'];
$showPrice       = (1 === $index || 2 === $index) ? $showPrice_hero : $showPrice_norm;
$price_label     = (1 === $index || 2 === $index) ? $price_label_hero : $price_label_norm;
...
$layout_direction = $layout_data === '1' ? 'wpte-card--l-r' : 'wpte-card--t-b';
$add_card_class = (1 === $index || 2 === $index) ? 'wpte-card--t-b wpte-card--hero-img hero-color' : $layout_direction;
$add_wrap_class = (1 === $index || 2 === $index) ? 'wpte-card--grid wpte-card--overlap wpte-card--overlap-stack' : '';
?>
<div class="wpte-card <?php echo esc_attr($add_card_class); ?>" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
	<div class="wpte-card__wrap <?php echo esc_attr($add_wrap_class); ?>">
		<div class="wpte-card__media">
			...
			<?php if ( ((1 === $index || 2 === $index) && '1' === $layout_data) && wte_array_get( $settings, 'showWishlist_hero', false ) ) :
        ...
        <div class="wpte-card__content">
			...
			if ( $showRating && (1 === $index || 2 === $index)) :
                \wptravelengineeb_get_rating( $trip_id, $rating_layout );
            endif;
            if ($layout_data === '2') echo '<div class="wpte-card__meta-wrapper">';
                if( 1 === $index || 2 === $index || '2' === $layout_data) : ?>
