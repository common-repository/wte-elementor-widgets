...
/**
 * Class Trips Module One Widget.
 *
 * @since 1.3.5
 */
class Widget_Trips_Module_One extends Widget { 
    
    /**
    *
    * @var $widget_name
    */
    public $widget_name = 'wptravelengine-trips-module-one';
    ...
    */
    protected function register_controls() {
        ...
        $controls = include WPTRAVELENGINEEB_PATH . 'includes/widgets/trips-module-one/controls.php';
	...
	protected function render() {
		...
		$tripsCount = '1' === $attributes['cardlayout'] ? 5 : 6;
