...
$selectors = array(
	...
	'image_border_radius'              => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-module .wpte-card' => '--img-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	),
	...
	'hero_padding'              => array('{{WRAPPER}} .wpte-elementor-widget .wpte-card.wpte-card--hero-img'=> '--content-padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',),
);
...
$controls = array(
	...
	'price_section'        => array(
		'type'        => \Elementor\Controls_Manager::TAB_STYLE,
		'label'       => __('Price', 'wptravelengine-elementor-widgets'),
		'condition' => array( 'showPrice' => 'yes', 'cardlayout' => '2' ),
		'subcontrols' => array(
			'price_tabs' => array(
				'type' => 'start_controls_tabs',
				'tabs' => array(
