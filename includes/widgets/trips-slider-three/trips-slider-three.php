...
/**
 * Class Trips Slider Three Widget.
 *
 * @since 1.3.6
 */
class Widget_Trips_Slider_Three extends Widget {
	 ...
	 * @var string
	 */
	public $widget_name = 'wptravelengine-trips-slider-three';
