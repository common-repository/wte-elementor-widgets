...
$image_size        = wte_array_get( $settings, 'image_size', 'activities-thumb-size' );
...
$viewMreBtn        = wte_array_get($settings, 'showViewMoreButton', false);
$viewMreBtnTxt     = wte_array_get($settings, 'viewMoreButtonText', __('View Details', 'wptravelengine-elementor-widgets'));
				...
				<div class="wpte-card__content">
					...
					<div class="wpte-card__hidden-content">
						<div>
							...
							<?php if($viewMreBtn && !empty($viewMreBtnTxt)){
								echo '<div class="wpte-card__price-wrapper">';
								?>
								<div class="wpte-card__button-wrap">
									<a href="<?php echo esc_url(get_the_permalink($trip_id)); ?>" class="wpte-card__button">
										<?php echo esc_html($viewMreBtnTxt); ?>
									</a>
								</div>
								<?php
							}
