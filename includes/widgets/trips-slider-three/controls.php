...
$selectors = array(
	...
	'card_background_color'            => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--g-bg: {{VALUE}};',
	),
	'card_padding'                     => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--g-p: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	),
	'card_border'                      => '{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card__wrap',
	'card_border_radius'               => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--g-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',

	),
	'card_boxshadow' => '{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card',

	// content section
	'content_alignment'            => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--content-alignment: {{VALUE}};',
	),
	'content_background_color'            => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--content-background: {{VALUE}};',
	),
	'content_padding'                     => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--content-padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	),
	'content_border'        => '{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card .wpte-card__content',
	'content_border_radius' => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--content-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',

	),
	'content_boxshadow' => '{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card .wpte-card__content',
	'content_width'                      => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' =>'--card-content-width: {{SIZE}}{{UNIT}};',
	),

	  // image section
	'image_scale'                      => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--img-fit: {{VALUE}};',
	),
	'image_width'                      => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--img-w: {{SIZE}}{{UNIT}};',
	),
	'image_height'                     => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--img-h: {{SIZE}}{{UNIT}};',
	),
	'animation_type'                   => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card img' => 'transition-timing-function: {{VALUE}};',
	),
	'img_animation_duration'           => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card img' => 'transition-duration: {{VALUE}}s;',
	),
	'image_border_radius'              => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--img-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	),
	'image_boxshadow'                   => '{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card__media .wpte-card__image',


	// title
	'title_typography'  => '{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card__title',
	'title_color'       => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--t-fc: {{VALUE}};'),
	'title_color_hover' => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--t-fc-h: {{VALUE}};'),
	'title_margin'      => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--t-m: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'),

	// location
	'location_typography' => '{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card .wpte-card__location',
	'location_icon_color' => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--l-ic: {{VALUE}};'),
	'location_icon_size'  => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--l-is: {{SIZE}}{{UNIT}};'),
	'location_margin'        => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--l-m: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'),
	'location_color'  => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--l-fc: {{VALUE}};'),
	'location_hover_color'  => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--l-fc-h: {{VALUE}};'),
	'location_hover_decoration'  => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--l-decoration: {{VALUE}};'),


	// meta
	'meta_typography'                  => '{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card .wpte-card__meta',
	'meta_color'                       => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--m-fc: {{VALUE}};',
	),
	'meta_icon_color'                  => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--m-ic: {{VALUE}};',
	),
	'meta_spacing'                     => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--m-sb: {{SIZE}}{{UNIT}};',
	),
	'meta_margin'                      => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--m-m: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	),
	'meta_icon_size'                     => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--m-is: {{SIZE}}{{UNIT}};',
	),
	
	// price
	'price_typography'                 => '{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card:not(.hero-color) .wpte-card__price .actual-price',
	'price_color'                      => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card:not(.hero-color)' => '--p-fc-n: {{VALUE}};',
	),
	'price_bg_color'                      => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three.wpte-adv-trips_two .wpte-card' => '--p-bg: {{VALUE}};',
	),
	'strike_typography'                => '{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card:not(.hero-color) .wpte-card__price .striked-price',
	'strike_color'                     => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card:not(.hero-color)' => '--p-fc-s: {{VALUE}};',
	),
	'price_margin'      => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card:not(.hero-color)' => '--p-m: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',),


	// feat tag
	'feat_typography'                => '{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card .wpte-badge_featured .wpte-badge__text',
	'feat_tag_color'                   => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--f-fc: {{VALUE}};',
	),
	'feat_tag_bg_color'                => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--f-bg: {{VALUE}};',
	),

	// discounttag
	'discount_typography'                => '{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card .wpte-badge_discount .wpte-badge__text',
	'discount_tag_color'               => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--d-fc: {{VALUE}};',
	),
	'discount_tag_bg_color'            => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--d-bg: {{VALUE}};',
	),

	// rating
	'rating_typography' => '{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card .wpte-card__rating',
	'rating_color'      => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card .wpte-card__rating' => '--r-fc: {{VALUE}};'),
	'rating_margin'     => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card .wpte-card__rating' => '--r-m: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',),
	
	// button
	'button_typography'          => '{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card .wpte-card__button',
	'button_padding'             => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--b-p: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',),
	'button_margin'              => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--b-m: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',),
	'button_bg_color'            => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--b-bg: {{VALUE}};',),
	'button_color'               => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--b-fc: {{VALUE}};',),
	'button_border'              => '{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card .wpte-card__button',
	'button_border_radius'       => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--b-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',),
	'button_boxshadow'           => '{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card .wpte-card__button',
	'button_bg_hover_color'      => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--b-bg-h: {{VALUE}};',),
	'button_hover_color'         => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--b-fc-h: {{VALUE}};',),
	'button_hover_border'        => '{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card .wpte-card__button:hover',
	'button_hover_border_radius' => array('{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card' => '--b-radius-h: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',),
	'button_hover_boxshadow'     => '{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-card .wpte-card__button:hover',

	//Slider Arrow
	'slider_arrow_padding'             => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three' => '--slider-arrow-padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	),
	'slider_arrow_bg_color'            => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three' => '--slider-arrow-bg-n: {{VALUE}};',
	),
	'slider_arrow_color'               => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three' => '--slider-arrow-color-n: {{VALUE}};',
	),
	'slider_arrow_bg_color_hover'      => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three' => '--slider-arrow-bg-h: {{VALUE}};',
	),
	'slider_arrow_color_hover'         => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three' => '--slider-arrow-color-h: {{VALUE}};',
	),
	'slider_arrow_border'              => '{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-swiper-btn-prev, {{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-swiper-btn-next',
	'slider_arrow_border_radius'       => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three' => '--slider-arrow-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	),
	'slider_arrow_box_shadow'          => '{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-swiper-btn-prev, {{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-swiper-btn-next',
	'slider_arrow_border_hover'        => '{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-swiper-btn-prev:hover, {{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three .wpte-swiper-btn-next:hover',
	'slider_arrow_border_radius_hover' => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three' => '--slider-arrow-radius-h: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	),
	'slider_arrow_size'                => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three ' => '--slider-arrow-size: {{SIZE}}{{UNIT}};',
	),
	'slider_arrow_offset'              => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three' => '--slider-arrow-offset: {{SIZE}}{{UNIT}};',
	),

	// slider pagination.
	'slider_dots_active_color'         => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three' => '--slider-pagination-active-color: {{VALUE}};',
	),
	'slider_dots_color'                => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three' => '--slider-pagination-color: {{VALUE}};',
	),
	'slider_dots_spacing'              => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-trips-slider_three' => '--slider-pagination-spacing: {{SIZE}}{{UNIT}};',
	),
);


$controls = array(
	'trips_slider_two_settings' => array(
	...
	'content_section'      => array(
		...
		'subcontrols' => array(
			...
			'content_width'         => array(
				...
				'selectors'  => $selectors['content_width'],
				'condition' => array(
					'cardlayout' => '3',
				),
			),
				...
				'tabs' => array(
					...
					'slider_navigation_hover'  => array(
						...
						'subcontrols' => array(
							'slider_arrow_bg_color_hover' => array(
								'type'      => \Elementor\Controls_Manager::COLOR,
								'label'     => esc_html__('Background Color Hover', 'wptravelengine-elementor-widgets'),
								'selectors' => $selectors['slider_arrow_bg_color_hover'],
							),
							'slider_arrow_color_hover'    => array(
								'type'      => \Elementor\Controls_Manager::COLOR,
								'label'     => esc_html__('Color Hover', 'wptravelengine-elementor-widgets'),
								'selectors' => $selectors['slider_arrow_color_hover'],
							),
							'slider_arrow_border_hover'   => array(
								'type'      => \Elementor\Group_Control_Border::get_type(),
								'label'     => esc_html__('Border Color Hover', 'wptravelengine-elementor-widgets'),
								'selector' => $selectors['slider_arrow_border_hover'],
							),
							'slider_arrow_border_radius_hover' => array(
								'type'       => \Elementor\Controls_Manager::DIMENSIONS,
								'label'      => __('Border Radius Hover', 'wptravelengine-elementor-widgets'),
								'size_units' => array('px', '%'),
