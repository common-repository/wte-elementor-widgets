...
$show_meta_data    = wte_array_get( $settings, 'showTripMeta', [ 'showDuration', 'showGroupSize', 'showDifficulty', 'showActivities' ] );
...
<div class="wpte-card wpte-card--t-b" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
	<div class="wpte-card__wrap">
		...
		<div class="wpte-card__content">
			...
			<?php if($showPrice || $showButton) echo '<div class="wpte-card__price-wrapper">';
				if ( $showPrice && $priceType === '3' ) : ?>
			...
			if( $showPrice || $showButton) echo '</div>'; // End of wrapper .wpte-card__price-wrapper ?>
		</div>
