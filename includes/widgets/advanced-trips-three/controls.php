...
$selectors = array(
	...
	'card_background_color'            => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-adv-trips_three .wpte-card' => '--g-bg: {{VALUE}};',
	),
	'card_padding'                     => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-adv-trips_three .wpte-card' => '--g-p: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	),
	'card_border'                      => '{{WRAPPER}} .wpte-elementor-widget.wpte-adv-trips_three .wpte-card__wrap',
	'card_border_radius'               => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-adv-trips_three .wpte-card' => '--g-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',

	),
	'card_boxshadow'                   => '{{WRAPPER}} .wpte-elementor-widget.wpte-adv-trips_three .wpte-card__wrap',
	...
	'price_bg_color'                      => array(
		'{{WRAPPER}} .wpte-elementor-widget.wpte-adv-trips_three .wpte-card' => '--p-bg: {{VALUE}};',
	),
	...
	'additional_settings'   => array(
		...
		'subcontrols' => array(
			...
			'showTripMeta'  => array(
				...
				'default' => ['showDuration', 'showGroupSize', 'showDifficulty', 'showActivities'],
			),
			'durationType'          => array(
				'type'      => 'SELECT',
