...
/**
 * Class Advanced Trips One Widget.
 *
 * @since 1.3.5
 */
class Widget_Advanced_Trips_One extends Widget {
	 ...
	 * @var string
	 */
	public $widget_name = 'wptravelengine-advanced-trips-one';
