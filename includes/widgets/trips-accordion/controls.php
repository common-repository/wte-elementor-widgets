...
/**
 * Trips Accordion Widget Controls.
 *
 * @since 1.3.0
...
$selectors = array(
	...
	'card_border'              => '{{WRAPPER}} .wpte-elementor-widget .wpte-card .wpte-card__wrap',
	'card_border_radius'       => array('{{WRAPPER}} .wpte-elementor-widget .wpte-card' => '--g-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',),
	'card_border_radius_hover' => array('{{WRAPPER}} .wpte-elementor-widget .wpte-card:has([aria-expanded="true"])' => '--g-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',),
	...
	// price
	'price_typography'  => '{{WRAPPER}} .wpte-elementor-widget .wpte-card .wpte-card__price :is(ins, label)',
	'price_color'       => array('{{WRAPPER}} .wpte-elementor-widget .wpte-card' => '--p-fc-n: {{VALUE}};',),
	'price_bg_color'    => array('{{WRAPPER}} .wpte-elementor-widget .wpte-card' => '--p-bg: {{VALUE}};',),
	'strike_typography' => '{{WRAPPER}} .wpte-elementor-widget .wpte-card .wpte-card__price del',
	'strike_color'      => array('{{WRAPPER}} .wpte-elementor-widget .wpte-card' => '--p-fc-s: {{VALUE}};',),
	'price_margin'      => array('{{WRAPPER}} .wpte-elementor-widget .wpte-card' => '--p-m: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',),
...
$controls = array(
	'trips_accordion_layout_settings' => array(
		'type'        => 'control_section',
		'label'       => __('Layout', 'wptravelengine-elementor-widgets'),
		'subcontrols' => array(
			'trips_card_gap'         => array(
				'type'       => 'SLIDER',
				'label'      => esc_html__('Gap', 'wptravelengine-elementor-widgets'),
				'size_units' => array('px', '%'),
				'range'      => array(
					'%'  => array(
						'min' => 0,
	...
	'general_section'      => array(
		...
		'subcontrols' => array(
			...
			'card_border_radius_hover'    => array(
				'type'       => 'DIMENSIONS',
				'label'      => __('Hover Border Radius', 'wptravelengine-elementor-widgets'),
				'size_units' => array('px', '%'),
				'selectors'  => $selectors['card_border_radius_hover'],
