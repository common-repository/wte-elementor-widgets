...
$final_meta_data   = wte_array_get( $settings, 'showTripMeta', ['showDuration', 'showDifficulty', 'showActivities'] );
...
$add_card_class = (1 === $index || (2 === $index && '2' === $layout_data)) ? 'wpte-card--t-b wpte-card--hero-img hero-color' : 'wpte-card--l-r';
$add_wrap_class = (1 === $index || (2 === $index && '2' === $layout_data)) ? 'wpte-card--grid wpte-card--overlap wpte-card--overlap-stack' : '';
?>
<div class="wpte-card <?php echo esc_attr($add_card_class); ?>" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
	<div class="wpte-card__wrap <?php echo esc_attr($add_wrap_class); ?>">
		<div class="wpte-card__media">
			<?php if( $index === 1 || (2 === $index && '2' === $layout_data)) :
        ...
        <div class="wpte-card__content">
			...
			if ( $showRating && (1 === $index || (2 === $index && '2' === $layout_data))) :
