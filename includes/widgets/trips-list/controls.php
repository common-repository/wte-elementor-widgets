...
$selectors = array(
	...
	'content_alignment'            => array(
		'{{WRAPPER}} .wpte-elementor-widget .wpte-card:not(.hero-color)' => '--content-alignment: {{VALUE}};',
	),
	'content_background_color'            => array(
		'{{WRAPPER}} .wpte-elementor-widget .wpte-card:not(.hero-color)' => '--content-background: {{VALUE}};',
	),
	'content_padding'                     => array(
		'{{WRAPPER}} .wpte-elementor-widget .wpte-card:not(.hero-color)' => '--content-padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	),
	'content_border'                      => '{{WRAPPER}} .wpte-elementor-widget .wpte-card:not(.hero-color) .wpte-card__content',
	'content_border_radius'               => array(
		'{{WRAPPER}} .wpte-elementor-widget .wpte-card:not(.hero-color)' => '--content-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	...
	'title_color'       => array('{{WRAPPER}} .wpte-elementor-widget .wpte-card:not(.hero-color)' => '--t-fc: {{VALUE}};'),
	'title_color_hover' => array('{{WRAPPER}} .wpte-elementor-widget .wpte-card:not(.hero-color)' => '--t-fc-h: {{VALUE}};'),
	...
	'hero_title_price_bg_color' => array('{{WRAPPER}} .wpte-elementor-widget .wpte-card.wpte-card--hero-img'=> '--p-bg: {{VALUE}};'),
...
$controls = array(
	'adv_trip_layout_settings' => array(
		...
		'subcontrols' => array(
			...
			'trips_row_gap'         => array(
				...
				'selectors'  => [
					'{{WRAPPER}} .wpte-elementor-widget ' => '--gap:{{SIZE}}{{UNIT}}'
				],
				'condition' => array( 'cardlayout' => '3' ),
			),
			'cardlayout'       => array(
	...
	'additional_settings'   => array(
		...
		'subcontrols' => array(
			...
			'durationType'          => array(
				...
				'condition' => array( 'showTripMeta' => 'showDuration', 'cardlayout' => '2' ),
			),
			'showLocation'          => array(
			...
			'showStrikedPrice'      => array(
				...
				'type'    => 'SWITCHER',
				'default' => 'yes',
				'condition' => array( 'showPrice' => 'yes', 'cardlayout!' => '1' ),
			),
			'priceLabel'    => array(
				'default'   => __( 'from', 'wptravelengine-elementor-widgets' ),
				'type'      => 'TEXT',
				'condition' => array( 'showStrikedPrice' => 'yes', 'showPrice' => 'yes', 'cardlayout!' => '1' ),
	...
	'hero_post_styling'        => array(
		...
		'subcontrols' => array(
			...
			'hero_title_price_bg_color' => array(
				'type'      => \Elementor\Controls_Manager::COLOR,
				'label'     => __('Price Background Color', 'wptravelengine-elementor-widgets'),
				'selectors' => $selectors['hero_title_price_bg_color'],
			),
	...
	'featured_section'     => array(
		...
		'condition' => array( 'showFeaturedRibbon' => 'yes', 'cardlayout!' => '1' ),
		'subcontrols' => array(
	...
	'discount_section'     => array(
		...
		'condition' => array( 'showDiscount' => 'yes', 'cardlayout!' => '1' ),
		'subcontrols' => array(
	...
	'rating_section'       => !class_exists('Wte_Trip_Review_Init') ? array() : array(
		...
		'condition'   => array( 'showReviews' => 'yes', 'cardlayout!' => '1' ),
		'subcontrols' => array(
			'rating_layout' => array(
				'label'     => __( 'Layouts', 'wptravelengine-elementor-widgets' ),
				'type'      => 'SELECT',
