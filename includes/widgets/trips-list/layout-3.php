...
$showRating		   = wte_array_get( $settings, 'showReviews_hero', false );
...
$final_meta_data = (1 === $index ) ? $show_hero_meta : $show_meta_data;
...
$add_card_class = 1 === $index ? 'wpte-card--t-b wpte-card--hero-img hero-color' : 'wpte-card--l-r';
?>
<div class="wpte-card <?php echo esc_attr($add_card_class); ?>" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
	<div class="wpte-card__wrap wpte-card--grid wpte-card--overlap wpte-card--overlap-stack">
		<div class="wpte-card__media">
			<?php if( $index === 1 ) :
                if ( wte_array_get( $settings, 'showFeaturedRibbon_hero', false ) && $is_featured ) : ?>
            ...
            if( $index === 1 ) : ?>
                <div class="wpte-card__meta">
                    <?php if ( in_array('showDuration', $final_meta_data) && $meta->duration['days'] != 0 ) :
                        ...
                        $set_duration_types   = $settings['durationType_hero'];
