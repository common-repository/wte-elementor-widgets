...
/**
 * Class Trips List Widget.
 *
 * @since 1.3.5
 */
class Widget_Trips_List extends Widget {
	 ...
	 * @var string
	 */
	public $widget_name = 'wptravelengine-trips-list';
	 ...
	 * @var array
	 */
	protected $keywords = array( 'trip', 'wp travel engine', 'wte','list' );

	/**
	 * Style dependencies.
	 */
	public function get_style_depends() {
		wp_register_style( 'wpte-trips-list', plugin_dir_url( WPTRAVELENGINEEB_FILE__ ) . 'dist/css/wpte-trips-list.css' );
		
		return array( 'wpte-trips-list' );
	}
