...
/**
 * Class Trips Slider Two Widget.
 *
 * @since 1.3.6
 */
class Widget_Trips_Slider_Two extends Widget {
	 ...
	 * @var string
	 */
	public $widget_name = 'wptravelengine-trips-slider-two';
